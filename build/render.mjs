      ...
      <div class="container">
        <div class="split" style="align-items:start;grid-template-columns:1.3fr .9fr">
          <div class="reveal">
            ...
            <form class="form-card" id="contact-form" action="/api/contact" method="post" data-validate data-endpoint="/api/contact" data-success="Thanks — your message was sent. We typically reply within one business day." novalidate>
              <div class="form-grid">
                <div class="field"><label for="name">Name <span class="req" aria-hidden="true">*</span></label><input class="control" type="text" id="name" name="name" placeholder="Jane Doe" autocomplete="name" maxlength="120" required /><span class="error-msg"></span></div>
                <div class="field"><label for="email">Work Email <span class="req" aria-hidden="true">*</span></label><input class="control" type="email" id="email" name="email" placeholder="jane@company.com" autocomplete="email" maxlength="254" required /><span class="error-msg"></span></div>
                <div class="field"><label for="company">Company</label><input class="control" type="text" id="company" name="company" placeholder="Company Inc." autocomplete="organization" maxlength="160" /><span class="error-msg"></span></div>
                <div class="field"><label for="website">Website</label><input class="control" type="url" id="website" name="website" placeholder="https://" autocomplete="url" maxlength="300" /><span class="error-msg"></span></div>
                ...
                <div class="field full"><label for="details">Project Details <span class="req" aria-hidden="true">*</span></label><textarea class="control" id="details" name="details" placeholder="Share your goals, timeline and any details that help us understand your project." maxlength="5000" required></textarea><span class="error-msg"></span></div>
                ...
                <div class="field full hp-field" aria-hidden="true"><label for="website-hp">Leave this field empty</label><input class="control" type="text" id="website-hp" name="website-hp" tabindex="-1" autocomplete="off" /></div>
